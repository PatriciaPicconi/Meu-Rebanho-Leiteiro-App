...
class _TelaInseminarState extends State<TelaInseminar> {
  ...
  // Função auxiliar para criar os botões do menu inferior
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomAppBar(
        color: Colors.blue, // Cor azul para combinar com o tema desta tela
        child: SingleChildScrollView(
          scrollDirection: Axis.horizontal,
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              _botaoMenu(context, Icons.agriculture, "VACAS", Colors.greenAccent, const TelaVaca()), // Botão que volta para vacas
...
// O FormularioInseminar permanece igual, conforme seu código original
