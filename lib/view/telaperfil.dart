          ...
          if (snapshot.hasData && snapshot.data!.exists) {
            ...
            return const Center(
              child: Padding(
                ...
                child: Text(
                  "Documento do usuário não foi encontrado no Firestore. Verifique se o ID da coleção é 'usuarios' e o ID do documento é o UID do Auth.",
                ...
                SizedBox(
                  ...
                  child: OutlinedButton.icon(
                    ...
                    onPressed: () => _mostrarAlertaConfirmacao(
                      ...
                      mensagem: "Tem certeza que deseja encerrar a sessão em 'Meu Rebanho Leiteiro'?",
                ...
                SizedBox(
                  ...
                  child: TextButton.icon(
                    ...
                    onPressed: () => _mostrarAlertaConfirmacao(
                      ...
                      mensagem: "Atenção! Esta ação é irreversível e apagará todos os dados cadastrados. Deseja continuar?",
                      ePerigoso: true,
